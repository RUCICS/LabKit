...
const adminResetLabQuotaToday = `-- name: AdminResetLabQuotaToday :execrows
UPDATE submissions
...
func (q *Queries) AdminResetLabQuotaToday(ctx context.Context, arg AdminResetLabQuotaTodayParams) (int64, error) {
	result, err := q.db.Exec(ctx, adminResetLabQuotaToday, arg.LabID, arg.CreatedAt)
	if err != nil {
		return 0, err
	}
...
type CreateFreeSubmissionParams struct {
	UserID      int64              `json:"user_id"`
	LabID       string             `json:"lab_id"`
	KeyID       int64              `json:"key_id"`
	ArtifactKey string             `json:"artifact_key"`
...
func (q *Queries) CreateFreeSubmission(ctx context.Context, arg CreateFreeSubmissionParams) (Submissions, error) {
	row := q.db.QueryRow(ctx, createFreeSubmission,
		arg.UserID,
		arg.LabID,
		arg.KeyID,
		arg.ArtifactKey,
